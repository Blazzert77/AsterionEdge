...
OutputDir=..\release
OutputBaseFilename=AsterionEdge-Setup-v0.3.0-dev.3-dev.3
Compression=lzma2
...
Source: "..\asterion-star-citizen-cockpit-v0.3.0-dev.3-dev.3.icuewidget"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{group}\Importer le widget iCUE"; Filename: "{app}\asterion-star-citizen-cockpit-v0.3.0-dev.3-dev.3.icuewidget"
...
Filename: "{app}\asterion-star-citizen-cockpit-v0.3.0-dev.3-dev.3.icuewidget"; Description: "Importer le widget Asterion dans iCUE"; Flags: shellexec postinstall skipifsilent
